# Generated by Django 3.0.4 on 2020-05-09 13:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ul_mailing_time', models.CharField(max_length=20, null=True, verbose_name='Время рассылки')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Send_weeks',
            fields=[
                ('sw_id', models.AutoField(primary_key=True, serialize=False, verbose_name='ID')),
                ('sw_day', models.IntegerField(verbose_name='Номер дня недели')),
                ('ul_id_w', models.ForeignKey(db_column='ul_id_w', on_delete=django.db.models.deletion.DO_NOTHING, to='bot.Userlist', verbose_name='ID пользователя')),
            ],
        ),
        migrations.CreateModel(
            name='Eventtaglist',
