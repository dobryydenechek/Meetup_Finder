...
def message_handler(message):
    ...
    elif message.text.lower() == "что означают тэги?":
        bot.send_message(message.chat.id, 'Фронтенд — все, что браузер может читать, выводить на экран и / или запускать. То есть это HTML JS CSS\n\n'
